...
function createEventListeners() {
  ...
  // if (loginBtn.addEventListener) { // For Mozilla
  //   console.log("in if");
  //   loginBtn.addEventListener("submit", login, false);
  // }
  // else if (loginBtn.attachEvent) { // For IE
  //   console.log("in else");
  //   loginBtn.attachEvent("onsubmit", login);
  // }
